...
export class ComplianceComponent implements OnInit {
  ...
  dataMap: Record<string, ComplianceData> = {
    'eu-ai-act': {
        ...
        ourSolution: 'Obrioxia provides "Compliance-in-a-Box" for Article 12. We auto-log every inference with millisecond timestamps and hash-chaining to prove traceability without human intervention.',
        checklist: [
    ...
    'gdpr': {
        ...
        ourSolution: 'Our ledger reconstructs the exact state of the AI agent at the moment of decision. By logging the prompt context and model version, you can reproduce the output to satisfy Data Subject Access Requests (DSARs).',
        checklist: [
            ...
            'Immutable Audit Trail for Consent Management'
        ]
    },
    'soc2': {
        title: 'SOC 2 Type II',
        ...
        ourSolution: 'Obrioxia acts as your external monitor. Our immutable logs provide the evidentiary trail required by auditors to prove that your AI systems were not tampered with during the audit window.',
        checklist: [
    ...
    'iso42001': {
        ...
        ourSolution: 'We provide cryptographic provenance. You can prove exactly which data inputs led to which model outputs, ensuring full traceability from training to inference.',
        checklist: [
